...
//var task2 = Task(text: "christ", dueDate: someDateTime! as Date, priority: .low, completed: true)
...
//var array = [Task]()
////array = tasks.completeTasks() as! [Task]
//array = tasks.incompleteTasks() as! [Task]
//print(array.count)
//for t in array {
//    print(t.toString())
//}
...
//var array = [Task]()
//
////array = tasks.pastDueTasks() as! [Task]
////array = tasks.tasksBetween(currentDate, and: someDateTime19!) as! [Task]
//array = tasks.tasks(priority: .medium) as! [Task]
//print(array.count)
//for t in array {
//    print(t.toString())
//}
